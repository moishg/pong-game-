...
A classic Pong game built with Python and Pygame where you play against the computer!
...
```bash
git clone https://github.com/moishg/pong-game-.git
cd pong-game-
```
